...
template <typename scalar_t>
void TetrahedralCPUSliceForward(const int nthreads, 
                                const scalar_t* grid, 
...
template <typename scalar_t>
void TetrahedralCPUSliceBackward(const int nthreads,
		...
		for(int i=0;i<grid_per_ch;++i)
		{
            ...
            grid_grad[id00x_r + shift * (i + grid_per_ch * 0)] += grad_o_r * w00x_r;
            grid_grad[id0xx_r + shift * (i + grid_per_ch * 0)] += grad_o_r * w0xx_r;
            grid_grad[id111_r + shift * (i + grid_per_ch * 0)] += grad_o_r * w111_r;

            grid_grad[id000_g + shift * (i + grid_per_ch * 1)] += grad_o_g * w000_g;
            grid_grad[id00x_g + shift * (i + grid_per_ch * 1)] += grad_o_g * w00x_g;
            grid_grad[id0xx_g + shift * (i + grid_per_ch * 1)] += grad_o_g * w0xx_g;
            grid_grad[id111_g + shift * (i + grid_per_ch * 1)] += grad_o_g * w111_g;

            grid_grad[id000_b + shift * (i + grid_per_ch * 2)] += grad_o_b * w000_b;
            grid_grad[id00x_b + shift * (i + grid_per_ch * 2)] += grad_o_b * w00x_b;
            grid_grad[id0xx_b + shift * (i + grid_per_ch * 2)] += grad_o_b * w0xx_b;
...
void TetrahedralCPUSliceBackwardLaucher(const torch::Tensor &grad_output, 
